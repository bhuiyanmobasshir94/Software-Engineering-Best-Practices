...
HASHERS = ('django.contrib.auth.hashers.PBKDF2PasswordHasher', 'django.contrib.auth.hashers.BCryptSHA256PasswordHasher')
...
def get_hashers():
    hashers = []
    for hasher_path in HASHERS: #settings.PASSWORD_HASHERS:
